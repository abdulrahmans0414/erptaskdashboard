    ...
    >
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-3">
          <div
            className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl bg-gradient-to-br ${department.color} text-white shadow-lg group-hover:scale-110 transition-transform`}
          >
            {department.icon}
          </div>
          <div>
        ...
        <div
          className={`px-2.5 py-1 rounded-lg text-xs font-bold border ${performanceBg}`}
        >
          {completionRate}% Done
        </div>
      </div>
