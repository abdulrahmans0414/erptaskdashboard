...
const BranchManagement = () => {
  ...
  useEffect(() => {
    if (!showModal && !showTransferModal && !confirmDelete && !showBinModal) return;
    const onKey = (e) => {
      if (e.key === "Escape") {
        setShowModal(false);
  ...
  }, [showModal, showTransferModal, confirmDelete, showBinModal]);
        ...
        {showModal && (
          <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            ...
            <motion.div
              ...
              className="bg-white w-full max-w-5xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] z-50 border border-slate-100"
            >
              {/* Modal Header */}
              ...
              <form onSubmit={handleSubmit} className="flex-1 overflow-hidden flex flex-col md:flex-row">
                ...
                <div 
                  ...
                  className="flex-1 md:w-5/12 overflow-y-auto px-6 py-5 border-r border-slate-100 space-y-4 custom-scrollbar bg-slate-50/30"
                >
                ...
                <div className="flex-1 md:w-7/12 flex flex-col bg-white">
                ...
                <div className="bg-slate-50 rounded-2xl p-3.5 border border-slate-200/50 flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-[9px] font-bold px-1.5 py-0.2 rounded bg-slate-200/70 text-slate-655">
